...
public class ImportTest extends AbstractTest {
	...
	public void success() throws Exception {
		...
		// check imported data
		assertEquals("created 2 Persons", 2, pb.getPersons().size());
		assertTrue("created Maria", pb.hasPerson("Maria"));
		assertTrue("created Manel", pb.hasPerson("Manel"));
		assertEquals("Maria has 4 Contacts", 4, pb.getPersonByName("Maria").getContacts().size());
		assertEquals("Manel has 3 Contacts", 3, pb.getPersonByName("Manel").getContacts().size());
