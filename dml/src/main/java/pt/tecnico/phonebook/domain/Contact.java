...
public class Contact extends Contact_Base {
	...
	protected Contact() { /* for XML import and derived classes */ }
	...
	protected void init(Person person, String name, Integer phoneNumber) throws InvalidPhoneNumberException, NameAlreadyExistsException {
		setName(name);
